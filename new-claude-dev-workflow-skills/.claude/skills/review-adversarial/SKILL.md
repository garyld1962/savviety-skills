...
description: "Adversarial code review via opposing AI model (Codex/Gemini). Use after the code-review skill passes and the diff is 200+ lines, when changes touch auth, payments, data migrations, or architectural boundaries, or when the user explicitly requests adversarial review. Do NOT use for small low-risk diffs (code-review is sufficient), BA deliverables, or reviewing an existing code review."
---

## When to Use

- /code-review has passed and diff is 200+ lines
...
- Small, low-risk diffs — `/code-review` is sufficient
- BA deliverables — use `/ba-review-adversarial`
...
The repo-delivery schema (see `_rubrics/repo-delivery`) is required —
...
clean    → /code-review             (full review — REQUIRED)
