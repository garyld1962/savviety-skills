...
Read the project instruction file and tsconfig.json before applying. These rules adapt to the project's strictness level and conventions.
...
- **`console.log` in production code.** If the project has a structured logger (check the project instruction file), `console.log`/`console.error` in service code bypasses structured logging. Exception: test files, scripts, CLI tools.
