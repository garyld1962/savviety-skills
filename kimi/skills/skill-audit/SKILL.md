---
name: skill-audit
description: Use periodically or when setting up a new project to audit Claude Code
  skills/plugins/agents, research marketplaces, gap-analyze, and implement recommendations.
whenToUse: Use periodically or when setting up a new project to audit Claude Code
  skills/plugins/agents, research marketplaces, gap-analyze, and implement recommendations.
disableModelInvocation: true
---


# /skill:skill-audit — Skills & Plugin Ecosystem Audit
...
```
/skill:skill-audit                        # Full audit: inventory → research → gaps → recommendations
/skill:skill-audit --inventory            # Just list current skills and plugins (no research)
/skill:skill-audit --research             # Just research available options (no changes)
/skill:skill-audit --implement            # Skip recommendations, implement all findings
/skill:skill-audit --scope plugins        # Audit plugins only
/skill:skill-audit --scope skills         # Audit skills only
```
...
- Run `/skill:checkpoint` to verify nothing broke
