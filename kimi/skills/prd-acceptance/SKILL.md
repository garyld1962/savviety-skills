...
- **Inputs:** path to the PRD/AERS to verify against; the built / running application. Calls `/skill:prd-validate` if the artifact is incomplete and `/skill:domain-review` when defects warrant a structured list.
