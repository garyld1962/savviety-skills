---
name: skill-help
description: List available skills or show detailed help for a specific skill. Use
  when the user asks 'what skills are available', 'help with a skill', 'what can you
  do', 'list skills', or '/skill-help'.
whenToUse: List available skills or show detailed help for a specific skill. Use when
  the user asks 'what skills are available', 'help with a skill', 'what can you do',
  'list skills', or '/skill-help'.
disableModelInvocation: true
---


# /skill:skill-help — Agent Reference
...
- `<name>` — show detailed help for the named skill (e.g., `/skill:skill-help plan`)
...
4. **Present as a table** per category:
   ...
   | Skill | Description |
   |-------|-------------|
	   | `/skill:thesis` | Interrogate the product or architectural thesis |
   | `/skill:grill-me` | Stress-test a plan or design by walking every decision branch |
   ```

5. **Footer.** Add: `Run /skill:skill-help <name> for detailed usage of any skill.`
