---
name: sync-main
description: 'Sync current branch with main: fetch, rebase, resolve conflicts. Use
  when your branch is behind main or before creating a PR.'
whenToUse: 'Sync current branch with main: fetch, rebase, resolve conflicts. Use when
  your branch is behind main or before creating a PR.'
---


# /skill:sync-main — Sync Branch with Main
...
- Before running /skill:checkpoint or /skill:domain-review (ensure you're testing against current main)
...
```
/skill:sync-main                    # Rebase current branch on main
/skill:sync-main --stash            # Auto-stash uncommitted changes, sync, pop stash
/skill:sync-main --merge            # Use merge instead of rebase (for shared branches)
```
...
Next: run /skill:checkpoint to verify everything still builds and passes.
```
