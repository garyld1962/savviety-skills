...
- A goal is already clear and you're ready to write the AERS → skip to `/skill:prd-validate`
...
Goal validated. Recommended next step:
  /skill:prd-validate   — write requirements against this goal
...
- Do NOT write requirements — that belongs in `/skill:prd-validate`
