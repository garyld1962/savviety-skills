---
name: thesis
description: Interrogate to discover the single-sentence product or architectural
  thesis, then audit all planned features and decisions against it.
whenToUse: Interrogate to discover the single-sentence product or architectural thesis,
  then audit all planned features and decisions against it.
---


# /skill:thesis — Application & Architectural Thesis
