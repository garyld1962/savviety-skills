---
name: dep-audit
description: 'Audit project dependencies: check for vulnerabilities, outdated packages,
  unused deps, and license compliance. Use periodically or before releases.'
whenToUse: 'Audit project dependencies: check for vulnerabilities, outdated packages,
  unused deps, and license compliance. Use periodically or before releases.'
---


# /skill:dep-audit — Dependency Health Check
...
```
/skill:dep-audit                           # Full audit
/skill:dep-audit --security-only           # Just vulnerability check
/skill:dep-audit --check outdated          # Just outdated packages
/skill:dep-audit --check unused            # Just unused dependency detection
/skill:dep-audit --check licenses          # Just license compliance
```
