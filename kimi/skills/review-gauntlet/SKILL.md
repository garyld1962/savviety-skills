...
description: Use when a code review's conclusions need scrutiny. Reviews THE REVIEW
  via 3 lenses (Skeptic, Architect, Pragmatist). Returns SOLID / MIXED / UNRELIABLE.
whenToUse: Use when a code review's conclusions need scrutiny. Reviews THE REVIEW
  via 3 lenses (Skeptic, Architect, Pragmatist). Returns SOLID / MIXED / UNRELIABLE.
---


# /skill:review-gauntlet -- Meta-Review of Code Reviews
...
- After /skill:domain-review produces its report and you want a quality check on the review itself
...
- You need a code review -- use /skill:domain-review
- You need to review specs / BA deliverables -- use /skill:spec-review-adversarial
...
```
/skill:review-gauntlet <review-file>
/skill:review-gauntlet .domain-review/review-latest.json
/skill:review-gauntlet docs/code-reviews/2026-03-15-review.md
```
