---
name: repo-status
description: 'Reports live repo state: branch, working tree, unpushed commits, stashes,
  and open PRs. Read-only snapshot for orienting at the start of a session or after
  a long break.'
whenToUse: 'Reports live repo state: branch, working tree, unpushed commits, stashes,
  and open PRs. Read-only snapshot for orienting at the start of a session or after
  a long break.'
---
