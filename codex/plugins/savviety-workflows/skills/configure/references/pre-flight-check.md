...
| `<template_path>` | The template source path (for example, `codex/templates/config.toml`) |
...
1. Check `.codex/config.toml` exists.
   If not: "Use $configure for codex-config or copy `codex/templates/config.toml`."
