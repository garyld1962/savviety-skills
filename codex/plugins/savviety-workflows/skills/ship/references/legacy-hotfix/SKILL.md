...
- The normal /plan, /code-review, /checkpoint pipeline is too slow
...
1. **Speed over ceremony.** Skip full /code-review and multi-specialist analysis. Keep the security check.
