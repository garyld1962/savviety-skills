---
name: simplify
description: "Explain dense progress reports, task or wave summaries, blockers and decision requests in plain language. Use $simplify, 'explain that simply', or before user-facing PRD/plan execution updates. Simplifies explanations, not code."
---
...
With `$simplify`, use the latest substantive assistant update or execution
...
underlying workflow and evidence intact. Native editing and review remain
the right tools when the user wants to simplify an implementation.
